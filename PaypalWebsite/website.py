...
@app.route("/CashoutHistoryView/<int:sid>")
@admin_required
def CashoutHistoryView(user, sid):
    ...
    total_ads = targetUser["interstitial"] + targetUser["rewarded"]

    total_redeemed_gems = sum(c["gems"] for c in targetUser["cashouts"])
